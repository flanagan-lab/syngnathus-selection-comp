...
kruskal.test(data$prop_developed[data$species == "floridae"] ~ data$mating_status[data$species == "floridae"])

kruskal.test(data$prop_developed[data$species == "fuscus"] ~ data$mating_status[data$species == "fuscus"])

kruskal.test(data$prop_developed[data$species == "scovelli"] ~ data$mating_status[data$species == "scovelli"])
