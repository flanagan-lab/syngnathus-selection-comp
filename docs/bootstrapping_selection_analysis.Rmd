...
Because some of the S. fuscus trials only had one male and/or one female mate (which cannot have a variance calculated on it for partitioning I, if all non-mated individuals are removed), I first need to sub-set the data to only include trials with 2 or more mated individuals.
